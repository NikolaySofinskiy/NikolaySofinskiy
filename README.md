...
<div style="margin-top: 15px;">
  <div style="font-size: 24px; font-weight: bold;">Привет, меня зовут Николай! 👋</div>
  <br />
  <br />
  <div style="font-size: 18px; font-weight: bold; color: #555;">Занимаюсь аналитикой данных 📈</div>
</div>
